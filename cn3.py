...
# Input CIDR and calculate subnet mask
cidr = 0
...
# Check connectivity between two clients
while True:
    print("Enter another IP (192.B.C.D format) or exit(1):", end="")
